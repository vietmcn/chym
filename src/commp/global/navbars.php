...
if ( !function_exists( 'Chym_navbar_dropdown_m' ) ) {
    function Chym_navbar_dropdown_m()
    {
        ...
        if ( $mobile->isMobile() ) {
            ...
            $out .= '<li><ion-icon name="finger-print"></ion-icon> <a href="#">Đăng Ký</a></li>';
            $out .= '<li class="hotline"><ion-icon name="call"></ion-icon> <a href="tel:19001267">HotLine Mua Hàng <strong>0886 40 95 98</strong></a></li>';
            $out .= '</ul>';
            $out .= '</div>';
            __render( $out );
        }
